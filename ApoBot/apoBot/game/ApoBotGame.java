...
@ Override public void setKeyFunction ( int function ) { 
if ( this . bTutorial ) { 
...
@ Override public void setMouseFunction ( String function ) { 
...
super . setWAIT_TIME_RENDER ( ( int ) ( all / this . waitTimeRender . size ( ) + 2 ) ) ; 
 ...
 else if ( ( all / this . waitTimeRender . size ( ) < super . getWAIT_TIME_RENDER ( ) - this . FPS_COUNT - 1 ) && ( super . getWAIT_TIME_RENDER ( ) - this . FPS_COUNT >= 20 ) ) { 
...
while ( count >= 0 ) { 
if ( ( this . mainCommands . length >= this . getLevel ( ) . getCommandsMenu ( ) - count ) && ( this . mainCommands [ this . mainCommands . length - 1 - count ] . getCommand ( ) > - 1 ) ) { 
...
curX = ApoBotConstants . GAME_WIDTH - 32 * 4 - 4 * 5 ; 
while ( count >= 0 ) { 
if ( ( this . functionOneCommands . length >= this . getLevel ( ) . getFunctionsOneMenu ( ) - count ) && ( this . functionOneCommands [ this . functionOneCommands . length - 1 - count ] . getCommand ( ) != - 1 ) ) { 
...
curX = ApoBotConstants . GAME_WIDTH - 32 * 4 - 4 * 5 ; 
while ( count >= 0 ) { 
if ( ( this . functionTwoCommands . length >= this . getLevel ( ) . getFunctionsTwoMenu ( ) - count ) && ( this . functionTwoCommands [ this . functionTwoCommands . length - 1 - count ] . getCommand ( ) > - 1 ) ) { 
