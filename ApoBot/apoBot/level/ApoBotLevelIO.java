...
@ Override public boolean readLevel ( DataInputStream data ) throws EOFException , IOException { 
this . levels = new ArrayList < ApoBotLevel > ( ) ; 
...
@ Override public boolean writeLevel ( DataOutputStream data ) throws IOException { 
